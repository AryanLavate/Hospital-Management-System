...
SECRET_KEY = 'django-insecure-uuo1p(8ipo-4-eyny6erzd1i94di^g5f@gwe$a2^jfh20h0ztb'
...
# Load database config from db_config.py (single file to edit per device)
try:
    import db_config
    _db_host = db_config.DB_HOST
    _db_user = db_config.DB_USER
    _db_pass = db_config.DB_PASS
    _db_port = db_config.DB_PORT
    _db_name = getattr(db_config, 'DB_NAME', 'smart_hospital_db')
except ImportError:
...
# Force login screen after browser closes
